...
public class ScriptExportLd4scLinkingToDpla {
	...
	public static void main(String[] args) throws Exception {
		...
		File exportFile=new File("target/ld4sc_schemaorg.ids.csv");
		...
		it.iterate(repositoryFolder,  transformToEdmInternal, "University of Illinois at Urbana–Champaign", "University of Illinois at Urbana–Champaign");
