...
Data providers may use classes and properties from any of the three vocabularies to describe each of their datasets. All three vocabularies allow data providers to:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MzQ5NTIzNDYsODkzOTg4MTA4LC0xND
