...
Data providers may use classes and properties from any of the three vocabularies.All three vocabularies allow data providers to:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDY5OTAzOTUsODkzOTg4MTA4LC0xND
