...
Data providers may use classes and properties from any of the three vocabularies to describe each of their datasets. To enable Europeana to aggregate and ingest the datasetAll three vocabularies allow data providers to:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU5MzY5NDA0LDg5Mzk4ODEwOCwtMTQ5MD
IwNzYyMSw3OTcxMDUxMzMsMTY4Njc2NzAyXX0=
-->