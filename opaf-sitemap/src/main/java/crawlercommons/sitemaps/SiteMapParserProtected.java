...
public class SiteMapParserProtected {


    public static final Logger LOG = LoggerFactory.getLogger(SiteMapParserProtected.class);

    /** According to the specs, 50K URLs per Sitemap is the max */
    protected static final int MAX_URLS = 50000;
    ...
    protected final static Tika TIKA = new Tika();
    protected final static MediaTypeRegistry MEDIA_TYPE_REGISTRY = MediaTypeRegistry.getDefaultRegistry();

    protected final static List<MediaType> XML_MEDIA_TYPES = new ArrayList<MediaType>();
    protected final static List<MediaType> TEXT_MEDIA_TYPES = new ArrayList<MediaType>();
    protected final static List<MediaType> GZ_MEDIA_TYPES = new ArrayList<MediaType>();
    static {
        initMediaTypes();
    }
    ...
    public SiteMapParserProtected() {
        this(true);
    }

    public SiteMapParserProtected(boolean strict) {
        this.strict = strict;
    }
     ...
     */
    protected boolean urlIsLegal(String sitemapBaseUrl, String testUrl) {
     ...
     * Please note that this is a protected static method which is called once per
     * CLASS (not per instance / object)
     */
    protected static void initMediaTypes() {
